              ...
              >
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    <label className="text-[10px] uppercase tracking-widest font-bold text-warm-gray">Coiffeur cible</label>
                  </div>
                  <select
                    value={targetBarber}
                  ...
                  >
                    <option value="dummy_barber">💈 Appel d'offres ouvert à tous les coiffeurs (Simulation active)</option>
                    {barbers.map(b => (
              ...
              >
                ...
                <div className={`p-4 border rounded-sm ${theme === 'dark' ? 'bg-gold/5 border-gold/25' : 'bg-yellow-500/5 border-gold/20'}`}>
                  ...
                  <p className="text-[9px] text-warm-gray mb-3 leading-relaxed">
                    Ajustez votre prix à la baisse ou à la hausse. Les coiffeurs indépendants de Casablanca peuvent accepter l'offre ou formuler une contre-offre immédiatement.
                  </p>
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-warm-gray leading-relaxed max-w-sm mx-auto mt-1">
                Votre appel d'offres a été publié avec succès. Les coiffeurs disponibles à Casablanca peuvent maintenant consulter votre proposition et vous faire des offres en temps réel !
              </p>
            </div>

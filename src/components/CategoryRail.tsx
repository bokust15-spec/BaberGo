...
export default function CategoryRail({ selected, onSelect, theme }: CategoryRailProps) {
  const chipClass = (active: boolean) =>
    `flex items-center gap-1.5 px-4 py-2 rounded-full border text-[10px] font-bold uppercase tracking-widest whitespace-nowrap shrink-0 transition-colors ${
      active
  ...
  return (
    <div className="relative left-1/2 right-1/2 -mx-[50vw] w-screen md:static md:left-0 md:right-0 md:mx-0 md:w-full overflow-x-auto scrollbar-hide mb-6">
      <div className="flex gap-2 w-max px-4 md:px-0">
